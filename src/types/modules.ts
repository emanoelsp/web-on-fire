...
export const ALL_MODULES: ModuleMeta[] = [
  {
    ...
    atividades: [
      ...
      "Arquitetura e App Router",
      "Principais arquivos e pastas",
      "Boas práticas no dia a dia",
      "Desafio: seu primeiro sistema",
    ],
    href: "/modulos/nextjs",
  },
  {
  ...
  },
  {
    ...
    desc: "Fetch, Axios, TanStack Query — como consumir APIs REST externas com loading, erro e cache.",
    icon: "🔌",
    tag: "integração",
    atividades: ["Fetch e Axios com TypeScript", "TanStack Query na prática"],
    href: "#",
  },
  {
    id: "roteamento",
