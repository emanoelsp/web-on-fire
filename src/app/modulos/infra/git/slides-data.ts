...
git push -u origin main`,
  ...
  },
  {
    ...
    type: "branch",
    tag: "Branches",
    title: "O grafo de commits, visualmente",
    subtitle: "Cada bolinha é um commit. A feature nasce da main e volta pelo merge.",
    mainLabel: "main",
    featureLabel: "feature/sobre",
    mainCommits: ["init", "home"],
    featureCommits: ["sobre.md", "ajuste"],
    mergeLabel: "merge (PR)",
    tailCommits: ["segue"],
    note: "É exatamente o desenho que git log --oneline --graph --all mostra no terminal.",
    tip: "A main (laranja) nunca para de existir; a feature (azul) é um caminho paralelo que diverge e, depois do Pull Request, se junta de volta no commit de merge (verde).",
  },
  {
    id: 9,
    type: "code",
...
$ ______________ "feat: adiciona pagina de perfil"`,
  ...
  },
  {
    ...
    xp: 50,
    nextHref: "/modulos/infra/terminal",
    nextLabel: "Aula 04: Terminal CMD & Bash →",
  },
];
